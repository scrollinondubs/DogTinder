...
echo "Removing worktree: ../epic-9-worktree..."
git worktree remove ../epic-9-worktree --force 2>/dev/null || echo "  Worktree not found or already removed"
echo "Removing worktree: ../task-10-worktree..."
git worktree remove ../task-10-worktree --force 2>/dev/null || echo "  Worktree not found or already removed"
